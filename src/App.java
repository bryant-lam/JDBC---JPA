...
public class App {
    ...
    private static void bryantsDemo(){
        EntityManagerFactory factory = Persistence.createEntityManagerFactory("museumDb");
        EntityManager em = factory.createEntityManager();

        //Find artpieces from building_id = 1
        Building newBuilding = em.find(Building.class, 1);
        System.out.println();
        var artpieces = em.createQuery("SELECT a from artpieces a WHERE a.building.buildingId = " + newBuilding.getBuildingId(), ArtPiece.class).getResultList();
        System.out.println("Art Pieces from Building ID " + newBuilding.getBuildingId());
        System.out.println("================================");
        ...
        //Find viewings from visitor_id = 1
        Visitor newVisitor = em.find(Visitor.class, 1);
        var viewings = em.createQuery("SELECT v from viewings v WHERE v.visitor.visitorId = " + newVisitor.getVisitorId(), Viewing.class).getResultList();
        System.out.println("Viewings from Visitor ID " + newVisitor.getVisitorId());
        System.out.println("================================");
